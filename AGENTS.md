...
- Sidebar workspace panes are stateless nested tmux attaches; manage only panes whose tty maps to `pi-agent-hub-*`, and close Hub-owned side panes before stopping the dashboard TUI.
